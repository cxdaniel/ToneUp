...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1282: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1283: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1284: (x0,x1) => x0.createElement(x1),
      _1285: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _1286: (x0,x1) => x0.removeAttribute(x1),
      _1287: (x0,x1) => x0.getAttribute(x1),
      _1291: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1313: x0 => globalThis.URL.revokeObjectURL(x0),
      _1314: x0 => x0.remove(),
      _1315: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      _1316: (x0,x1,x2,x3,x4,x5) => x0.drawImage(x1,x2,x3,x4,x5),
      _1317: x0 => globalThis.URL.createObjectURL(x0),
      _1318: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1318(f,arguments.length,x0) }),
      _1319: (x0,x1,x2,x3) => x0.toBlob(x1,x2,x3),
      ...
      _1325: (x0,x1) => x0.replaceChildren(x1),
      _1326: x0 => x0.click(),
      _1327: (x0,x1) => x0.appendChild(x1),
      ...
      _1373: () => new SpeechSynthesisUtterance(),
      _1374: x0 => x0.pause(),
      _1375: x0 => x0.resume(),
      ...
      _1382: (x0,x1) => x0.speak(x1),
      _1383: x0 => x0.cancel(),
      _1384: x0 => x0.getVoices(),
      _1386: (x0,x1) => x0.initialize(x1),
      _1391: Date.now,
      ...
      _1520: (x0,x1) => new WebSocket(x0,x1),
      _1521: (x0,x1) => x0.send(x1),
      _1522: (x0,x1,x2) => x0.close(x1,x2),
      _1523: (x0,x1) => x0.close(x1),
      _1524: x0 => x0.close(),
      _1525: () => new AbortController(),
      _1526: x0 => x0.abort(),
      _1527: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1528: (x0,x1) => globalThis.fetch(x0,x1),
      _1529: (x0,x1) => x0.get(x1),
      _1530: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1530(f,arguments.length,x0,x1,x2) }),
      _1531: (x0,x1) => x0.forEach(x1),
      _1532: x0 => x0.getReader(),
      _1533: x0 => x0.cancel(),
      _1534: x0 => x0.read(),
      ...
      _1546: x0 => new BroadcastChannel(x0),
      ...
      _1560: x0 => x0.trustedTypes,
      _1561: (x0,x1) => { x0.src = x1 },
      _1562: (x0,x1) => x0.createScriptURL(x1),
      _1563: x0 => x0.nonce,
      _1564: (x0,x1) => x0.debug(x1),
      _1565: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1565(f,arguments.length,x0) }),
      _1566: x0 => ({createScriptURL: x0}),
      _1567: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1568: (x0,x1) => x0.querySelectorAll(x1),
      _1569: (x0,x1) => x0.key(x1),
      _1570: (x0,x1) => x0.item(x1),
      _1793: (x0,x1) => x0.getContext(x1),
      _1799: (s, m) => {
        try {
      ...
      _1829: o => String(o),
      _1830: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      _1831: o => {
      ...
      _1832: o => [o],
      _1833: (o0, o1) => [o0, o1],
      _1834: (o0, o1, o2) => [o0, o1, o2],
      _1835: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1845: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
        const setValue = dartInstance.exports.$wasmF64ArraySet;
        for (let i = 0; i < length; i++) {
          setValue(wasmArray, wasmArrayOffset + i, jsArray[jsArrayOffset + i]);
        }
      },
      _1846: x0 => new ArrayBuffer(x0),
      _1847: s => {
        if (/[[\]{}()*+?.\\^$|]/.test(s)) {
            s = s.replace(/[[\]{}()*+?.\\^$|]/g, '\\$&');
        }
      ...
      _1850: x0 => x0.groups,
      _1851: x0 => x0.flags,
      _1852: x0 => x0.multiline,
      _1853: x0 => x0.ignoreCase,
      _1854: x0 => x0.unicode,
      _1855: x0 => x0.dotAll,
      _1856: (x0,x1) => { x0.lastIndex = x1 },
      _1857: (o, p) => p in o,
      _1858: (o, p) => o[p],
      _1859: (o, p, v) => o[p] = v,
      _1860: (o, p) => delete o[p],
      _1861: x0 => x0.random(),
      _1862: (x0,x1) => x0.getRandomValues(x1),
      _1863: () => globalThis.crypto,
      _1864: () => globalThis.Math,
      _1865: Function.prototype.call.bind(Number.prototype.toString),
      _1866: Function.prototype.call.bind(BigInt.prototype.toString),
      _1867: Function.prototype.call.bind(Number.prototype.toString),
      _1868: (d, digits) => d.toFixed(digits),
      _1950: () => globalThis.google.accounts.id,
      ...
      _1978: x0 => x0.error,
      _1980: x0 => x0.credential,
      _1991: x0 => { globalThis.onGoogleLibraryLoad = x0 },
      _1992: f => finalizeWrapper(f, function() { return dartInstance.exports._1992(f,arguments.length) }),
      _2041: (x0,x1) => { x0.responseType = x1 },
      _2042: x0 => x0.response,
      _2131: (x0,x1) => { x0.oncancel = x1 },
      _2137: (x0,x1) => { x0.onchange = x1 },
      _2177: (x0,x1) => { x0.onerror = x1 },
      _2317: (x0,x1) => { x0.nonce = x1 },
      ...
      _2730: (x0,x1) => { x0.preload = x1 },
      _2731: x0 => x0.buffered,
      _2734: x0 => x0.currentTime,
      _2735: (x0,x1) => { x0.currentTime = x1 },
      _2736: x0 => x0.duration,
      _2741: (x0,x1) => { x0.playbackRate = x1 },
      _2754: (x0,x1) => { x0.volume = x1 },
      _2771: x0 => x0.code,
      _2772: x0 => x0.message,
      _2846: x0 => x0.length,
      ...
      _3350: (x0,x1) => { x0.src = x1 },
      _3352: (x0,x1) => { x0.type = x1 },
      _3356: (x0,x1) => { x0.async = x1 },
      _3358: (x0,x1) => { x0.defer = x1 },
      _3362: (x0,x1) => { x0.text = x1 },
      _3394: x0 => x0.width,
      _3395: (x0,x1) => { x0.width = x1 },
      _3396: x0 => x0.height,
      _3397: (x0,x1) => { x0.height = x1 },
      _3818: () => globalThis.window,
      _3858: x0 => x0.document,
      _3861: x0 => x0.location,
      _3880: x0 => x0.navigator,
      _4142: x0 => x0.trustedTypes,
      _4144: x0 => x0.localStorage,
      _4152: x0 => x0.href,
      _4269: x0 => x0.userAgent,
      _4270: x0 => x0.vendor,
      _4320: x0 => x0.data,
      _4367: (x0,x1) => { x0.onmessage = x1 },
      _4474: x0 => x0.length,
      _4691: x0 => x0.readyState,
      _4704: (x0,x1) => { x0.binaryType = x1 },
      _4707: x0 => x0.code,
      _4708: x0 => x0.reason,
      _6375: x0 => x0.type,
      _6376: x0 => x0.target,
      _6416: x0 => x0.signal,
      _6425: x0 => x0.length,
      _6484: () => globalThis.document,
      _6565: x0 => x0.body,
      _6567: x0 => x0.head,
      _6896: (x0,x1) => { x0.id = x1 },
      _8242: x0 => x0.value,
      _8244: x0 => x0.done,
      _8424: x0 => x0.size,
      _8425: x0 => x0.type,
      ...
      _8941: x0 => x0.url,
      _8943: x0 => x0.status,
      _8945: x0 => x0.statusText,
      _8946: x0 => x0.headers,
      _8947: x0 => x0.body,
      _12573: x0 => x0.name,
      _13290: () => globalThis.console,
      _13317: () => globalThis.speechSynthesis,
      _13318: (x0,x1) => { x0.lang = x1 },
      _13320: (x0,x1) => { x0.pitch = x1 },
      _13323: (x0,x1) => { x0.rate = x1 },
      _13325: (x0,x1) => { x0.text = x1 },
      _13326: (x0,x1) => { x0.voice = x1 },
      _13327: x0 => x0.voice,
      _13329: (x0,x1) => { x0.volume = x1 },
      _13330: (x0,x1) => { x0.onstart = x1 },
      _13331: (x0,x1) => { x0.onend = x1 },
      _13332: (x0,x1) => { x0.onpause = x1 },
      _13333: (x0,x1) => { x0.onresume = x1 },
      _13334: (x0,x1) => { x0.onerror = x1 },
      _13335: (x0,x1) => { x0.onboundary = x1 },
      _13337: x0 => x0.lang,
      _13338: x0 => x0.localService,
      _13339: x0 => x0.name,
