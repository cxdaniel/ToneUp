...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1332: (x0,x1) => x0.removeAttribute(x1),
      _1333: (x0,x1) => x0.getAttribute(x1),
      ...
      _1374: () => new SpeechSynthesisUtterance(),
      _1375: x0 => x0.pause(),
      _1376: x0 => x0.resume(),
      ...
      _1383: (x0,x1) => x0.speak(x1),
      _1384: x0 => x0.cancel(),
      _1385: x0 => x0.getVoices(),
      _1387: (x0,x1) => x0.initialize(x1),
      _1392: Date.now,
      ...
      _1521: (x0,x1) => new WebSocket(x0,x1),
      _1522: (x0,x1) => x0.send(x1),
      _1523: (x0,x1,x2) => x0.close(x1,x2),
      _1524: (x0,x1) => x0.close(x1),
      _1525: x0 => x0.close(),
      _1526: () => new AbortController(),
      _1527: x0 => x0.abort(),
      ...
      _1533: x0 => x0.getReader(),
      _1534: x0 => x0.cancel(),
      _1535: x0 => x0.read(),
      _1539: () => new XMLHttpRequest(),
      _1540: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1541: x0 => x0.send(),
      _1543: () => new FileReader(),
      _1544: (x0,x1) => x0.readAsArrayBuffer(x1),
      _1547: x0 => new BroadcastChannel(x0),
      _1548: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1548(f,arguments.length,x0) }),
      _1549: (x0,x1) => x0.postMessage(x1),
      _1550: x0 => x0.close(),
      ...
      _1561: x0 => x0.trustedTypes,
      _1562: (x0,x1) => { x0.src = x1 },
      _1563: (x0,x1) => x0.createScriptURL(x1),
      _1564: x0 => x0.nonce,
      _1565: (x0,x1) => x0.debug(x1),
      _1566: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1566(f,arguments.length,x0) }),
      _1567: x0 => ({createScriptURL: x0}),
      _1568: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1569: (x0,x1) => x0.querySelectorAll(x1),
      _1570: (x0,x1) => x0.key(x1),
      _1571: (x0,x1) => x0.item(x1),
      _1794: (x0,x1) => x0.getContext(x1),
      _1800: (s, m) => {
        try {
      ...
      _1830: o => String(o),
      _1831: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      _1832: o => {
      ...
      _1833: o => [o],
      _1834: (o0, o1) => [o0, o1],
      _1835: (o0, o1, o2) => [o0, o1, o2],
      _1836: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1846: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
        const setValue = dartInstance.exports.$wasmF64ArraySet;
        for (let i = 0; i < length; i++) {
          setValue(wasmArray, wasmArrayOffset + i, jsArray[jsArrayOffset + i]);
        }
      },
      _1847: x0 => new ArrayBuffer(x0),
      _1848: s => {
        if (/[[\]{}()*+?.\\^$|]/.test(s)) {
            s = s.replace(/[[\]{}()*+?.\\^$|]/g, '\\$&');
        }
      ...
      _1851: x0 => x0.groups,
      _1852: x0 => x0.flags,
      _1853: x0 => x0.multiline,
      _1854: x0 => x0.ignoreCase,
      _1855: x0 => x0.unicode,
      _1856: x0 => x0.dotAll,
      _1857: (x0,x1) => { x0.lastIndex = x1 },
      _1858: (o, p) => p in o,
      _1859: (o, p) => o[p],
      _1860: (o, p, v) => o[p] = v,
      _1861: (o, p) => delete o[p],
      _1862: x0 => x0.random(),
      _1863: (x0,x1) => x0.getRandomValues(x1),
      _1864: () => globalThis.crypto,
      _1865: () => globalThis.Math,
      ...
      _1890: x0 => x0.style,
      _1893: x0 => x0.src,
      _1894: (x0,x1) => { x0.src = x1 },
      _1895: x0 => x0.naturalWidth,
      _1896: x0 => x0.naturalHeight,
      _1912: x0 => x0.status,
      _1913: (x0,x1) => { x0.responseType = x1 },
      _1915: x0 => x0.response,
      _1951: () => globalThis.google.accounts.id,
      ...
      _1979: x0 => x0.error,
      _1981: x0 => x0.credential,
      _1992: x0 => { globalThis.onGoogleLibraryLoad = x0 },
      _1993: f => finalizeWrapper(f, function() { return dartInstance.exports._1993(f,arguments.length) }),
      _2042: (x0,x1) => { x0.responseType = x1 },
      _2043: x0 => x0.response,
      _2132: (x0,x1) => { x0.oncancel = x1 },
      _2138: (x0,x1) => { x0.onchange = x1 },
      _2178: (x0,x1) => { x0.onerror = x1 },
      _2318: (x0,x1) => { x0.nonce = x1 },
      _2551: (x0,x1) => { x0.src = x1 },
      _2562: x0 => x0.width,
      _2564: x0 => x0.height,
      _2721: x0 => x0.error,
      _2722: x0 => x0.src,
      _2723: (x0,x1) => { x0.src = x1 },
      _2731: (x0,x1) => { x0.preload = x1 },
      _2732: x0 => x0.buffered,
      _2735: x0 => x0.currentTime,
      _2736: (x0,x1) => { x0.currentTime = x1 },
      _2737: x0 => x0.duration,
      _2742: (x0,x1) => { x0.playbackRate = x1 },
      _2755: (x0,x1) => { x0.volume = x1 },
      _2772: x0 => x0.code,
      _2773: x0 => x0.message,
      _2847: x0 => x0.length,
      _3043: (x0,x1) => { x0.accept = x1 },
      _3057: x0 => x0.files,
      _3083: (x0,x1) => { x0.multiple = x1 },
      _3101: (x0,x1) => { x0.type = x1 },
      _3351: (x0,x1) => { x0.src = x1 },
      _3353: (x0,x1) => { x0.type = x1 },
      _3357: (x0,x1) => { x0.async = x1 },
      _3359: (x0,x1) => { x0.defer = x1 },
      _3363: (x0,x1) => { x0.text = x1 },
      _3395: x0 => x0.width,
      _3396: (x0,x1) => { x0.width = x1 },
      _3397: x0 => x0.height,
      _3398: (x0,x1) => { x0.height = x1 },
      _3819: () => globalThis.window,
      _3859: x0 => x0.document,
      _3862: x0 => x0.location,
      _3881: x0 => x0.navigator,
      _4143: x0 => x0.trustedTypes,
      _4145: x0 => x0.localStorage,
      _4153: x0 => x0.href,
      _4270: x0 => x0.userAgent,
      _4271: x0 => x0.vendor,
      _4321: x0 => x0.data,
      _4368: (x0,x1) => { x0.onmessage = x1 },
      _4475: x0 => x0.length,
      ...
      _8942: x0 => x0.url,
      _8944: x0 => x0.status,
      _8946: x0 => x0.statusText,
      _8947: x0 => x0.headers,
      _8948: x0 => x0.body,
      _12574: x0 => x0.name,
      _13291: () => globalThis.console,
      _13318: () => globalThis.speechSynthesis,
      _13319: (x0,x1) => { x0.lang = x1 },
      _13321: (x0,x1) => { x0.pitch = x1 },
      _13324: (x0,x1) => { x0.rate = x1 },
      _13326: (x0,x1) => { x0.text = x1 },
      _13327: (x0,x1) => { x0.voice = x1 },
      _13328: x0 => x0.voice,
      _13330: (x0,x1) => { x0.volume = x1 },
      _13331: (x0,x1) => { x0.onstart = x1 },
      _13332: (x0,x1) => { x0.onend = x1 },
      _13333: (x0,x1) => { x0.onpause = x1 },
      _13334: (x0,x1) => { x0.onresume = x1 },
      _13335: (x0,x1) => { x0.onerror = x1 },
      _13336: (x0,x1) => { x0.onboundary = x1 },
      _13338: x0 => x0.lang,
      _13339: x0 => x0.localService,
      _13340: x0 => x0.name,
