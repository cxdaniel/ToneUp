              ...
              child: Column(
                ...
                children: [
                  ...
                  Column(
                    spacing: 10,
                    children: [
                      ...provider!.focusedIndicators!.map(
                        (e) => _indicatorCard(e),
                      ),
                    ],
                  ),
                  mainActionButton(
                    ...
                    onTap:
                        (!subProvider.isPro &&
                            subProvider.currentMonthGoalLeft == 0)
                        ? _goPayWall
                        : _createNewGoal,
                  ),
                  SizedBox(height: 0),
                    ...
                    Text.rich(
                      ...
                      TextSpan(
                        children: [
                          ...
                          TextSpan(text: '${subProvider.currentMonthGoalLeft}'),
                          TextSpan(text: ' Goal generation left this month. '),
                          WidgetSpan(
                            ...
                            child: Padding(
                              ...
                              child: mainActionButton(
                                ...
                                context: context,
                                label: 'Upgrade Pro Plan',
                                backColor: theme.colorScheme.primary.withAlpha(
                                  40,
                                ),
                          ...
                          TextSpan(text: 'to enjoy unlimited plan.'),
                        ],
                      ),
                    ),
                ],
